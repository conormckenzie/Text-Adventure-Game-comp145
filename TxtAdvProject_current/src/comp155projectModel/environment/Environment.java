...
public class Environment {
    ...
    public static final String HINT2 = ". This dungeon has something strange about it";
    public static final String HINT3 = ". It is as if the space in this dungeon is discontinuous";
        
    public static final String AREA_NORMAL1 = "in a carcass-littered hallway";
    public static final String AREA_NORMAL2 = "in a decayed brick hallway";
    public static final String AREA_NORMAL2_ENTRY = AREA_NORMAL2 + ". A ghostly energy field is preventing you from turning back";
    public static final String AREA_NORMAL3 = "in a stone hallway";
    public static final String AREA_NORMAL4 = "in a damp, blood-stained hallway";
    public static final String AREA_OTHER1 = "in a torch gallery";
    public static final String AREA_OTHER4 = "in a damp and dimly-lit hallway";
    public static final String AREA_OTHER5 = "in a well-lit stone hallway. A shadow knight stands in front of you";
    public static final String AREA_TRAP1 = "in a booby-trapped room";
    public static final String AREA_TRAP4 = "in a tar pit, which you are unable to pull yourself out of";
    ...
    public static final String AREA_STAIRS_TOP3 = "at the top of a stone staircase";
    public static final String AREA_STAIRS_BOTTOM3 = "at the bottom of a stone staircase";
    public static final String AREA_STAIRS_MIDDLE3 = "on a stone staircase";
    public static final String AREA_FINISH1 = "in a sunlit meadow, with your home town in sight";
